 ...
 * @date 2021/12/4
 */
public abstract class PollerEventHelper implements SelectionKeyInfoProvider {

    private static final Logger LOG = LoggerFactory.getLogger(PollerEventHelper.class);
