 ...
 * @date 2021/12/4
 */
public class ReactorBasePollerEvent extends PollerEventHelper implements DemoPollerEvent {

    private static final Logger LOG = LoggerFactory.getLogger(ReactorBasePollerEvent.class);
    ...
    public ReactorBasePollerEvent(int eventType, SocketChannel socketChannel, Selector selector, Object attachment, NioSelectionKeyInfo selectionKeyInfo) {
