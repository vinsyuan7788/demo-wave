...
import com.demo.wave.test.unit.channel.socket.server.processor.Processor3;
 ...
 * @date 2021/12/6
 */
public class Poller3 extends Poller {

    private static final Logger LOG = LoggerFactory.getLogger(Poller3.class);
            ...
            try {
                ...
                while (selectedKeyIterator.hasNext()) {
                    ...
                    if (selectedKey.isReadable()) {
                        ...
                        threadPool.execute(new Processor3("processor-" + round.get(), createSelectionKeyInfo(selectedKey), this, needProcessResult));
                    }
