...
import com.demo.wave.fundamental.server.design.reactor.ReactorBaseServer;
 ...
 * @date 2021/12/1
 */
public class ReactorBaseMiddlewareTest {
    ...
    public void testStartServer() {
        server = new ReactorBaseServer(8686, ProcessingType.MIDDLE_WARE);
        server.startServer();
