 ...
 * @date 2021/12/4
 */
public class ExchangerThread2 extends ContainerRunner  {

    private static final Logger LOG = LoggerFactory.getLogger(ExchangerThread2.class);

    private SharableResource sharableResource;
    private InformationToExchange data;

    public ExchangerThread2(String threadName, SharableResource sharableResource) {
        setName(threadName);
        this.sharableResource = sharableResource;
        this.data = new InformationToExchange(2L, "Violet", BigDecimal.valueOf(40000L));
    }
