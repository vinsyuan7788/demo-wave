...
import com.demo.wave.test.unit.channel.socket.server.processor.Processor2;
 ...
 * @date 2021/12/6
 */
public class Poller2 extends Poller {
            ...
            try {
                ...
                while (selectedKeyIterator.hasNext()) {
                    ...
                    if (selectedKey.isReadable()) {
                        ...
                        threadPool.execute(new Processor2("processor-" + round.get(), "read", createSelectionKeyInfo(selectedKey), this, needProcessResult));
                    }
                    if (selectedKey.isWritable()) {
                        NeedProcessResult needProcessResult = needProcessWriteEvent(attachmentQueue);
                        if (!needProcessResult.isNeedProcess()) { continue; }
                        threadPool.execute(new Processor2("processor-" + round.get(), "write", createSelectionKeyInfo(selectedKey), this, needProcessResult));
                    }
