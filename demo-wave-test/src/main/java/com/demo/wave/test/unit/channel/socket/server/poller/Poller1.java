...
import com.demo.wave.test.unit.channel.socket.server.processor.Processor1;
 ...
 * @date 2021/12/6
 */
public class Poller1 extends Poller {

    private static final Logger LOG = LoggerFactory.getLogger(Poller1.class);
            ...
            try {
                ...
                while (selectedKeyIterator.hasNext()) {
                    ...
                    if (selectedKey.isReadable()) {
                        ...
                        threadPool.execute(new Processor1("processor" + round.get(), createSelectionKeyInfo(selectedKey), this, needProcessResult));
                    }
